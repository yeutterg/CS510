 ...
 * Greg Yeutter
 * gwy23@drexel.edu
 * DepthFirstSearch.java: Apply depth first search algorithm to find solution of legal moves
 */
...
public class DepthFirstSearch {
    ...
    public static void breadthFirstProblem(State givenState) {
        // Solve problem via breadth-first search with a LIFO queue
        ...
        while (!goalReached) {
            ...
            // Pop node from LIFO frontier and assign as current
            SearchGeneration.currentNode = SearchGeneration.lifoPop(SearchGeneration.frontier);
