 ...
 * with specified depth limit and the updated evaluation (OthelloState.evaluation) function
 */

public class OthelloGYEPlayer extends OthelloPlayer {
     ...
     */
    public OthelloGYEPlayer(int maxDepth) {
        if (maxDepth < 1) {
