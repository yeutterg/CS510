 ...
 * CS510 Winter 2015
 * Greg Yeutter
 * OthelloGYPlayer.java: Othello player implementing the standard minimax algorithm, with specified depth limit
 */

public class OthelloGYPlayer extends OthelloPlayer {
     ...
     */
    public OthelloGYPlayer(int maxDepth) {
        if (maxDepth < 1) {
