 ...
 * Greg Yeutter
 * gwy23@drexel.edu
 * AStarSearch.java: Apply A* graph search algorithm to find solution of legal moves
 * Heuristic is a Manhattan distance function between the master brick and the goal
 */
...
public class AStarSearch {
    ...
    public static void main(String[] args) {
        ...
        while (!goalReached) {
            ...
            // Compute heuristic and cost function for initial node
            SearchGeneration.computeManhattanHeuristicCost(SearchGeneration.currentNode);

            // Pop node from frontier with the lowest cost function (f-score)
            SearchGeneration.lowFPop();
            ...
            for (Move action : actions) {
                ...
                // Compute heuristic and cost function for child node
                SearchGeneration.computeManhattanHeuristicCost(SearchGeneration.childNode);
