 ...
 * This is the same as BreadthFirstSearch, except a LIFO queue is used instead of FIFO
 */
...
public class DepthFirstSearch {
    ...
    public static void main(String[] args) {
        ...
        while (!goalReached) {
            ...
            // Pop node from frontier (LIFO) and assign as currentNode
            SearchGeneration.lifoPop();
